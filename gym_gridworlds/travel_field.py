...
GRIDS["small_field"] = [
    ...
    [GRASS, GRASS, GRASS, ROCK, SWAMP, SWAMP, SWAMP, GRASS, ROCK, ROAD],
    [GRASS, GRASS, ROCK, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, ROCK, ROAD],
    [GRASS, GRASS, SWAMP, SWAMP, ROCK, SWAMP, SWAMP, SWAMP, SWAMP, ROAD],
    [GRASS, SWAMP, SWAMP, SWAMP, SWAMP, ROCK, SWAMP, GRASS, ROAD, ROAD],
    [GRASS, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, ROCK, ROCK, ROAD, GRASS],
...
GRIDS["large_field"] = [
    ...
    [GRASS, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, ROCK, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, ROCK, SWAMP, SWAMP, ROCK, ROCK, GRASS, GRASS, GRASS, GRASS, GRASS, GRASS, ROAD, GRASS, GRASS],
    [GRASS, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, ROCK, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, ROCK, SWAMP, SWAMP, SWAMP, ROCK, ROCK, GRASS, GRASS, GRASS, GRASS, GRASS, ROAD, ROAD, GRASS],
    ...
    [GRASS, GRASS, ROCK, ROCK, SWAMP, ROCK, ROCK, ROCK, ROCK, ROCK, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, ROCK, SWAMP, SWAMP, GRASS, ROCK, ROCK, GRASS, GRASS, GRASS, ROAD, GRASS],
    [GRASS, GRASS, GRASS, GRASS, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, ROCK, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, SWAMP, ROCK, SWAMP, SWAMP, ROCK, ROCK, GRASS, GRASS, GRASS, GRASS, ROAD, GRASS],
    ...
    [GRASS, GRASS, GRASS, GRASS, ROCK, SWAMP, ROCK, SWAMP, SWAMP, GRASS, GRASS, ROAD, ROAD, ROAD, GRASS, GRASS, GRASS, GRASS, GRASS, GRASS, ROAD, ROAD, ROAD, ROAD, ROAD, ROAD, ROAD, GRASS],
