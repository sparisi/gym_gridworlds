...
GRIDS["small_field_v1"] = [[char_dict[c] for c in list(s)] for s in small_field_v1]
GRIDS["large_field_v1"] = [[char_dict[c] for c in list(s)] for s in large_field_v1]
GRIDS["large_field_v0"] = [[char_dict[c] for c in list(s)] for s in large_field_v0]
