...
class Gridworld(gym.Env):
    """
    Base class for the basic gridworld, where the agent has to reach a goal
    and avoid penalty tiles. Harder versions include:
    ...
    Harder tasks are implemented in separate files.

    The grid is defined by a 2D array of integers, using global variables as IDs.
    For all details about the environment and how to define custom grids, please
    refer to the README.
